...
return new class extends Migration
{
    ...
    {
        Schema::create('rsg_usuario_sucursal', function (Blueprint $table) {
            $table->id();
            $table->foreignId('IN_USUARIO_ID')->constrained('rsg_users','id');
            $table->string('VC_COD_SUCURSAL');
            $table->string('VC_DES_SUCURSAL');
    ...
    {
        Schema::dropIfExists('rsg_usuario_sucursal');
    }
};
